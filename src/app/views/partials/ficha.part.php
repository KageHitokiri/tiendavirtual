<div id="ficha-producto" class="row">
  ...
  <img class="center-block img-responsive img-thumbnail" src="<?= \ProyectoWeb\entity\Product::RUTA_IMAGENES . '600_' . $producto->getFoto();?> " alt="<?= $producto->getNombre()?>" title="<?= $producto->getNombre()?>">
  <div class="caption">
